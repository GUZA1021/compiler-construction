...
public class ASTPrinter implements ExprVisitor<String>, StmtVisitor<String> {
  ...
  public String visitVar(Stmt.Var stmt){
    ...
    if (stmt.initializer != null){
      builder.append(space()).append(stmt.initializer.accept(this));
    }
    indent--;
  ...
  @Override
  public String visitFunction(Function stmt) {
    // TODO Auto-generated method stub
    throw new UnsupportedOperationException("Unimplemented method 'visitFunction'");
  }
